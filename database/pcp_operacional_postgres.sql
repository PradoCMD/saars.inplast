...
(
    ...
    'estoque_materia_prima',
    'google_published_sheet',
    'parse_estoque_almoxarifado_mp_google',
    'pubhtml',
    'INPLAST',
    'known',
    true,
    true,
    'Fonte operacional ativa de estoque de matéria-prima via publicação do almoxarifado.',
...
(
    ...
    'estoque_componente',
    'google_published_sheet',
    'parse_estoque_almoxarifado_componentes_google',
    'pubhtml',
    'INPLAST',
    'known',
    true,
    true,
    'Fonte operacional ativa de estoque de componentes via publicação do almoxarifado.',
